  ...
  render() {
    return (
      <React.Fragment>
        ...
        <img
          src="http://www.iconarchive.com/download/i89287/icons8/ios7/Weather-Partly-Cloudy-Rain.ico"
        ...
        <h2 id="condition" style={{ textAlign: "left", margin: "5%" }}>
          {" "}
          {this.state.condition}{" "}
        </h2>
        <p id="high-temp" style={{ float: "left", padding: " 1em" }}>
          {" "}
          High : {this.state.high} &deg;F
        </p>
        <p id="low-temp" style={{ float: "right", padding: " 1em" }}>
          {" "}
          Low: {this.state.low} &deg;F
        </p>
      </React.Fragment>
    );
  }
